...
export default class SettingsScreen extends React.Component {
  ...
  _getVar = async () => {
    ...
    this.setState({
      animating: true,
      nombre: JSON.parse(sesion).nombre,
      avatar:
        "http://www.axonplataforma.com.ar/images/avatar/" +
        JSON.parse(sesion).avatar
    });
    /*  await fetch(
      "https://api.axontraining.com/usuarios/" + JSON.parse(sesion).id
    )
